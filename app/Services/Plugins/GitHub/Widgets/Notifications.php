...
class Notifications extends BaseWidget
{
    ...
    {
        return 'widgets.github_notifications.name';
    }
    ...
    public function refresh()
    {
        ...
        try {
            ...
            $params = [
                'all' => $settings['show_all'] ?? false,
                'participating' => $settings['participating_only'] ?? false,
            ];

            $this->notifications = $apiClient->getNotifications($params);
    ...
    {
        return view('widgets.github.notifications', [
